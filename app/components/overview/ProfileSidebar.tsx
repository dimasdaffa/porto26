...
export default function ProfileSidebar() {
  return (
    <aside className="gh-profile-sidebar">
      ...
      <div className="gh-profile-meta">
        <div className="gh-profile-meta-item">
          <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
            <path d="M5.5 3.5a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm0-1.5a3.5 3.5 0 1 1 0 7 3.5 3.5 0 0 1 0-7Zm6.5 8c0-.551-.16-1.085-.477-1.586A3.46 3.46 0 0 0 10.5 7.5h-1a3.46 3.46 0 0 0-1.023.414C8.16 8.415 8 8.949 8 9.5h-.25C7.336 9.5 7 9.164 7 8.75V8.5a4.5 4.5 0 0 1 2.243-3.893A4.49 4.49 0 0 1 10.5 4.5h1c.818 0 1.544.29 2.257.607A4.5 4.5 0 0 1 16 9v.5a.75.75 0 0 1-.75.75H12Z" />
          </svg>
          <strong>26</strong> followers · <strong>28</strong> following
        </div>
        <div className="gh-profile-meta-item">
          <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
      ...
      <h4 className="gh-profile-section-title">Highlights</h4>
      <div className="gh-profile-meta-item">
        <span style={{ color: "var(--gh-yellow)" }}>⭐</span>
        <span className="gh-highlight-badge">PRO</span>
      </div>
